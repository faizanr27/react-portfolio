...
const Header = () => {
  ...
  return (
    <header className="bg-dark text-he w-full overflow-y-visible py-2 border-y-custom border-cuscol sticky top-0 backdrop-filter backdrop-blur-sm bg-opacity-25 z-10 max-w-full">
